...
function SocialMedia ({size} : {size: number}) {
    ...
    <a className="bg-black bg-opacity-50 p-4 rounded-full transition-all hover:scale-110 scale-100" href=""><Image src="/icons/facebook.svg" alt="Icon" width={size} height={size} /></a>
